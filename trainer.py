    ...
    def train(self, avg_metrics):
        ...
        for task_no in range(self.max_task): # cycle through the tasks # each task
            ...
            for round_ in range(self.num_rounds): # federated  comminication rounds
                ...
                # with open(f'newtask_{task_no}_round_{round_}_local_weights.pkl', 'wb') as file:
                ...
                # with open(f'newtask_{task_no}_round_{round_}_avg_weights.pkl', 'wb') as file:
                ...
                # # save model
                # model_save_dir_global = self.model_top_dir + '/debugmodels/repeat-'+str(self.seed+1)+ \
                ...
                print("batch_loss : ", batch_loss, "best_loss : ", best_loss, "vbatch_loss : ", vbatch_loss, 'vbatch_acc1', vbatch_acc1)
                if round_ > 0: 
