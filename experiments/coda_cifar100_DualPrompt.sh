...
CONFIG_VIT_DualP=configs/coda_cifar100_dualP.yaml
...
python -u run.py --config $CONFIG_VIT_DualP --gpuid $GPUID --repeat $REPEAT --memory $MEMORY --overwrite $OVERWRITE --debug_mode $DEBUG \
   --learner_type prompt --learner_name DualPrompt \
   --prompt_param 10 20 6 \
   --log_dir ${OUTDIR}/vit/dual-prompt --wandbgroup cifar-iid_DualPrompt
