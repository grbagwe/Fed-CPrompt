...
python -u run_async_clients.py --config $CONFIG_VIT_L2P --gpuid $GPUID --repeat $REPEAT --memory $MEMORY --overwrite $OVERWRITE --debug_mode $DEBUG \
   --learner_type prompt --learner_name L2P \
   --prompt_param 20 20 5 \
   --log_dir ${OUTDIR}/vit/L2P-prompt_iid_pacing  --wandbgroup cifar-iid_L2P_pacing  

# python -u run_async_clients.py --config $CONFIG_VIT_L2P_NIID_0_5 --gpuid $GPUID --repeat $REPEAT --memory $MEMORY --overwrite $OVERWRITE --debug_mode $DEBUG \
#    --learner_type prompt --learner_name L2P \
#    --prompt_param 20 20 5 \
#    --log_dir ${OUTDIR}/vit/L2P-prompt_niid_0_5_pacing  --wandbgroup cifar-Niid_L2P_pacing 